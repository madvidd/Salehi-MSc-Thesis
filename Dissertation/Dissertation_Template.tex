...
\hypersetup{
    colorlinks=false,
    pdfborder={0 0 0},
    pdftitle={Motion Prediction for Autonomous Driving: Controlled Architectural Ablations of SHARP},
    pdfauthor={Seyed Mohammad Salehi}
}
...
\begin{document}
\normalsize
\rhead{\textcolor{ashgrey}{Seyed Mohammad Salehi, MSc dissertation}}
\renewcommand{\headrulewidth}{0pt}
%%%%%%%%%%%%%%%%%COVER PAGE%%%%%%%%%%%%%%%%%
%\thispagestyle{empty}
\begin{center}
{\LARGE {\vspace*{0.5cm}\Huge\bf Motion Prediction for Autonomous Driving:\\Controlled Architectural Ablations of SHARP}}

\vspace{3em}
        {\Large \bf Seyed Mohammad Salehi}\\
        \vspace{2em}
        ...
        \vspace{2em}
        September 2026\\
       Supervised by: Prof. Saber Fallah and Kevin Wells\\
        \vspace{\stretch{1}}}
        \textcopyright Seyed Mohammad Salehi 2026
\end{center}
\pagenumbering{roman}
