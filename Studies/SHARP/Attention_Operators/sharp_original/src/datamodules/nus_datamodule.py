...
from .nus_dataset import NusDataset, collate_fn


class NusDataModule(LightningDataModule):
    def __init__(
        self,
        data_root: str,
        dataset: dict = {},
        ...
        super(NusDataModule, self).__init__()
